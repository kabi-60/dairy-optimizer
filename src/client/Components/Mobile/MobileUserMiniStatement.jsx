        ...
        <div className="rounded-t mb-0 px-4 py-3 border-0">
          <div className="flex flex-wrap items-center">
            <div className="relative w-full  flex-grow flex-1">
              <h1 className="text-white bg-black rounded-full px-5 py-2  border text-sm font-medium flex">
                <span className="mr-2 text-white h-0">
                  <BadgeInfo />
                </span>
                Statement
              </h1>
            ...
            <div className="relative w-full  max-w-full flex-grow flex-1 text-right">
              <Link
                ...
                className="bg-black text-white hover:text-black hover:bg-white hover:border hover:border-black text-xs font-bold uppercase px-2 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button"
              >
                See all
              </Link>
          ...
          <div className="block w-full overflow-x-auto text-black flex-1">
            <table className="w-full">
              <thead className="border-b border-black/20">
                <tr>
                  <th className="align-middle py-3 w-5  text-xs   uppercase font-semibold text-left">
                    Consumer Name
                  </th>
                  <th className="align-middle py-3 w-5  text-xs   uppercase font-semibold text-left">
                    Delevery Schedule
              ...
              <tbody>
                {currentRows.map((data, index) => (
                  <tr key={index}>
                    <th className="align-middle text-xs upprcase font-bold text-xs p-4 text-left">
                      {adminMap[data.admin] || data.username}
                    </th>
                    <td className="border-t-0 align-middle border-l-0 b  order-r-0 text-xs w-5 uppercase font-bold text-xs p-4">
                    ...
                    <td className="border-t-0 align-middle border-l-0 b  order-r-0 text-xs w-5 font-bold text-xs p-4">
                      <i className="fas fa-arrow-up text-emerald-500 mr-4"></i>
...
export default MobileUserMiniStatement;
