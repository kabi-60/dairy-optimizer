      ...
      <div className="relative ">
        <div className="flex mx-8  justify-center my-16">
          <div className="pb-4 relative">
            <div className="absolute z-50 bottom-10 left-[900px]">
            ...
            <div className="mx-auto  flex w-full   justify-center align-middle">
              <div className=" overflow-hidden    h-[80vh] w-[85%]  bg-white/5 border shadow-2xl   backdrop-blur-3xl rounded-xl ">
                <div className="flex">
                  <div className="relative w-[70%]">
                    <div className="absolute z-50 -bottom-16 left-[50%] transform -translate-x-1/2">
                  ...
                  <div className="flex items-center justify-center  w-[40%]">
                    <img src={pie} alt="" className="h-[600px]" />
                  </div>
                </div>
              </div>
            </div>
...
export default UserStatementtable;
